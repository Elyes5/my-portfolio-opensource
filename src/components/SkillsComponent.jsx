...
import DevComponent from "./DevComponent.jsx";
      ...
      <div className="grid grid-cols-9 sm:grid-cols-4">
        <div className="col-span-6 sm:col-span-3">
          <div className="sm:flex">
            <div className="flex-col">
              <h1 className="DMMono text-white ml-3 sm:indent-16 md:text-left text-center  md:text-2xl text-sm leading-relaxed">
                I have the experience !
              </h1>
              <h1 className="DMMono text-white ml-3 sm:indent-16 md:text-left text-center md:text-xl text-sm leading-relaxed">
                Here is my toolbelt for success.
              </h1>
            </div>
            <div className="flex-row-reverse sm:block flex">
              <img
                className="sm:w-24 sm:h-24 h-12 w-12 "
          ...
          <div className="md:indent-16">
            <div className="w-full grid sm:grid-cols-6 grid-cols-3 ">
              {devLogos.map((devLogo) => (
                <DevComponent
                  key={devLogo.icon}
                  icon={devLogo.icon}
                  name={devLogo.name}
                  duration={devLogo.duration}
                ></DevComponent>
              ))}
            </div>
          </div>
        ...
        <div className="col-span-3 sm:col-span-1 relative sm:min-h-full">
          <img
            ...
            className="rotate-180 min-w-full min-h-full"
            alt="wave2"
          />

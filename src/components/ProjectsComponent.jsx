...
function ProjectsComponent() {
  const projectsData = [
    ...
    },
    {
      ...
      title: "Quiz App",
      description:
        "Beautiful App built with XML and Java and Firebase to evaluate your android knowledge",
    ...
    },
    {
      ...
      title: "Info Plus",
      description:
        "E-commerce platform that sells gaming computers, headphones...",
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4">
            ...
            <div className="relative sm:col-span-1 col-span-1">
              ...
              <div className="absolute left-0 top-0 min-h-full min-w-full flex justify-center items-center">
                <img
                  ...
                  alt="projects"
                  className="min-w-full sm:h-min-full h-44-resp"
                />
              </div>
            </div>
          </div>
          <div className="DMMono col-span-2 p-1 sm:col-span-3 md:text-2xl sm:text-md text-sm flex justify-center items-center flex-col relative">
            ...
            <img
              ...
              alt="projectssvg"
              className="sm:absolute  sm:bottom-0 sm:left-0 w-9 sm:w-16  rotate-12"
            />
            <div className=" mt-10 lg:mb-2 md:mb-5 mb-3 flex justify-center">
              ...
              >
                <a
                  href="https://github.com/Elyes5"
                  className="inline-block md:p-5 p-3 border-2 border-blue-500 text-blue-500 underline-none rounded-lg hover:bg-blue-500 hover:text-neutral-800 "
                >
                  <i

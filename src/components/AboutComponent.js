        ...
        <div id="About">
            ...
            <div className = "grid grid-cols-8 sm:grid-cols-4 text-center">
              <div className="relative sm:col-span-1 col-span-2" >
                ...
                <img data-aos-duration="500" data-aos="fade-up" src="images/AboutMe.png" alt="AboutMe"  className="min-w-full sm:h-min-full "/>
                </div>
              </div>
              <div  className="DMMono col-span-6 p-1 sm:col-span-3 md:text-2xl sm:text-md text-sm sm:flex items-center flex-col">
                ...
                <img src="images/ArrowsLeft.svg" alt="left-arrow" className="sm:w-min-full w-1/5" data-aos="fade" data-aos-delay="250" data-aos-duration="250"/>
                    ...
                    <img src="images/ArrowsRight.svg" alt="right-arrow" data-aos="fade" data-aos-delay="500" data-aos-duration="250" className="sm:w-min-full w-1/5"/>
                </div>
              </div>
            </div>
        </div>
